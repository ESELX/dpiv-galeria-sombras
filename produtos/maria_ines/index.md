...
tags: galeria
status: not-started
hero_image: attachments/rascunho.jpg
hero_title: Rascunho
...
O Rascunho é um brinquedo acompanhado por uma espécie de caixa em grades, onde as peças são encaixadas para, no final, formar um quadro de sombras. As suas “paredes” são móveis, permitindo a utilização do brinquedo em diferentes ângulos e configurações.

As peças maiores são ligadas entre si através de peças em formato de “E”. O utilizador pode optar por fixar ou não várias peças “E” umas às outras, criando diferentes composições.

No final, ao projetar a luz de uma lanterna sobre a estrutura, é possível observar na parede o quadro de sombras criado. Dependendo de quem o observa, este pode assumir diferentes interpretações visuais, estimulando a imaginação e a criatividade.
